...
type DecisionProps = { loading: boolean; health: NflDataHealthResponse | null; decision: NflCapRosterDecisionResponse | null; branch: NflCapRosterBranch | null; selectedBranch: NflCapRosterBranch['id']; setSelectedBranch: (id: NflCapRosterBranch['id']) => void; target: number; setTarget: (value: number) => void; protectedPlayers: string[]; protectedGroups: string[]; setProtectedGroups: (value: string[]) => void; onRecompute: () => void; focusedAction: NflCapRosterAction | null; onFocusAction: (action: NflCapRosterAction | null) => void; onProtectPlayer: (id: string) => void; onOpenRule: (id: string) => void };
...
function FollowUp({ target, protectedPlayers, protectedGroups }: { target: number; protectedPlayers: string[]; protectedGroups: string[] }) {
