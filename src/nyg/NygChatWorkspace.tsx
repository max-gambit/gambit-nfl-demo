...
const STARTERS = [
  ...
  { label: 'College projection review', question: 'Compare Tyler Warren and Colston Loveland as historical draft prospects for a receiving role. Where does the evidence disagree?', detail: 'Historical prospect case · official production and attributed projection' },
  { label: 'Availability and coaching', question: 'Show Andrew Thomas’s official availability timeline and game participation in the historical Chiefs-week example.', detail: 'Dated reports · observed participation' },
