export const CONTEXT_GRAPH_ONBOARDING_TEAM_ID = (import.meta.env.VITE_ONBOARDING_TEAM_ID || 'NYG')
  .trim()
  .toUpperCase();
export const CONTEXT_GRAPH_ONBOARDING_DISABLED = import.meta.env.VITE_DISABLE_ONBOARDING_GATE !== 'false';
