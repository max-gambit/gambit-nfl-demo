...
function transactionMarketBriefSources(
  ...
  for (const comparable of comparableRows) {
    ...
    result.push({
      ...
      title: `${comparable.player_name} transaction`,
      ...
      data: {
        ...
        rows: [
          ...
          { k: 'Player', v: comparable.player_name },
          ...
          { k: 'Relevance', v: latest.influential_transactions.some((row) => row.event_id === comparable.event_id) ? 'Key transaction in the displayed result' : 'Supporting comparison' },
        ],
