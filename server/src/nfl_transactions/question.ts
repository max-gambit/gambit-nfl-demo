...
const POSITION_PATTERNS: Array<[NflPositionMarketGroup, RegExp]> = [
  ...
  ['IOL', /\b(?:interior offensive line(?:m[ae]n)?|interior o-?line(?:m[ae]n)?|guards?|centers?|iols?)\b/i],
  ['EDGE', /\b(?:edge rushers?|edge defenders?|edges?)\b/i],
  ['IDL', /\b(?:interior defensive line(?:m[ae]n)?|defensive tackles?|nose tackles?|idls?)\b/i],
