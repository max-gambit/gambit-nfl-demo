...
test('server intent matrix keeps prior context bounded to recognizable continuations', () => {
  const cases = [
    ...
    ['Which Giants contracts have the largest 2026 cap hits?', sellerChannel, 'general', false],
    ['Show me the Giants wide receiver contracts.', marketChannel, 'general', false],
